			...
			success: function(res) {
				...
				if(ipage) {
					...
					if(pageName == 'gallary') {
						...
						U.addScript(['asset/tab/tab.js'], function() {
							new Tab().pageInit();
						});
						...
						U.addScript(['asset/range/range.js'], function() {
						...
						U.addScript(['asset/linkageSelector/cityData.js', 'asset/linkageSelector/linkageSelector.js'], function() {
